...
// 	var infoAnswer struct {
// 		TestId primitive.ObjectID `json:"test_id,omitempty" bson:"test_id,omitempty"`
// 	}
// 	if err := json.NewDecoder(req.Body).Decode(&infoAnswer); err != nil {
// 		fmt.Println(err)
// 		pkg.SendError(w, "Invalid answer field", http.StatusBadRequest)
// 		return
// 	}

// 	newAnswer, errNewAnswer := entity.CreateNewAnswer(infoAnswer.TestId, emailId, email)

// 	if errNewAnswer != nil {
// 		pkg.SendError(w, "Failed to create answer: "+errNewAnswer.Error(), http.StatusInternalServerError)
// 		return
// 	}
